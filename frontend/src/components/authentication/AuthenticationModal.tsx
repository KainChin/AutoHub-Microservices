    ...
    <>
      ...
      {view !== 'FORGOT' && (
        <div className="fixed inset-0 z-50 bg-black/65 backdrop-blur-[10px] flex items-center justify-center p-4">
          <div className={`relative w-full transition-all duration-300 bg-[#0c101d]/90 backdrop-blur-[20px] border border-white/[0.12] rounded-[16px] p-8 shadow-2xl text-slate-100 animate-in fade-in zoom-in-95 my-6 ${
            view === 'REGISTER' ? 'max-w-[620px]' : 'max-w-[480px]'
          }`}>
            <button
              onClick={onClose}
